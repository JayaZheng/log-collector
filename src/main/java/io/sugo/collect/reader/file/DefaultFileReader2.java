...
public class DefaultFileReader2 extends AbstractReader {
    ...
    public static final String FILE_READER_LOG_OUT_DIR = "file.reader.log.out.dir";
                                ...
                                try {
                                    ...
                                    if (gmMap.size() > 0){
                                        ...
                                        if (writers.containsKey(day)){
                                            ...
                                            //TODO
                                            writers.put(day, ((FileWriter)writerFactory.createWriter()).withFile(conf.getProperty(FILE_READER_LOG_OUT_DIR) + day));
                                            writer = writers.get(day);
                                        }
